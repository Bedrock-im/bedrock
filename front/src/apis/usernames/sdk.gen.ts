...
import type { RegisterUsernameRegisterPostData, RegisterUsernameRegisterPostError, GetUsernameAddressGetData, GetUsernameAddressGetError, CheckUsernameAvailableAvailableGetData, CheckUsernameAvailableAvailableGetError } from './types.gen';
...
export const getUsernameAddressGet = <ThrowOnError extends boolean = false>(options: Options<GetUsernameAddressGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<unknown, GetUsernameAddressGetError, ThrowOnError>({
        url: '/{address}',
        ...options
    });
};
...
export const checkUsernameAvailableAvailableGet = <ThrowOnError extends boolean = false>(options: Options<CheckUsernameAvailableAvailableGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<unknown, CheckUsernameAvailableAvailableGetError, ThrowOnError>({
        url: '/available',
        ...options
    });
};